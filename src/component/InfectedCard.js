    ...
    return (
        <Card className='infected-card'>
            ...
            <Card.Title>Infected</Card.Title>
                <Card.Subtitle className="mb-2 text-muted fw-700 fs-3 b">{infected}</Card.Subtitle>
                <Card.Text>
                    <span className='d-inline-block mt-3'>Number of infect cases of COVID-19</span>
